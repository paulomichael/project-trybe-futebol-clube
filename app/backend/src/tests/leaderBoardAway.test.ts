...
describe('Leader Board Away', () => {
  ...
  before(async () => {
    sinon
      ...
      .stub(leaderBoardAwayService, "getLeaderBoardAway")
      .resolves(leaderBoardAwayMock);
  });

  after(()=>{
    (leaderBoardAwayService.getLeaderBoardAway as sinon.SinonStub).restore();
  })



    it('GET /leaderboard/away', 
    async () => {
